...
class FindBar(QWidget):
    def __init__(self, target: QTextEdit, scope: QWidget):
        ...
        self.input.setPlaceholderText("Find in this pane…")
        self.input.setAccessibleName("Search text")
    ...
    def _highlight(self):
        ...
        self.count.setText(
            ...
            else ("No matches" if self.input.text() else "0/0")
        )
